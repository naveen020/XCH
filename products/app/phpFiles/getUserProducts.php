...
if (isset( $_GET['userId'] ) &&  isset($_GET['userName'])) {
    ...
    if( $con  ) {
          ...
          $sql = "SELECT * FROM Pbooks INNER JOIN PURelations on PURelations.productId  = Pbooks.productId WHERE PURelations.userId = '$userId' "; 

          $eleSql = "SELECT * FROM Pelectronics INNER JOIN PURelations on PURelations.productId  = Pelectronics.eleId WHERE PURelations.userId = '$userId' "; 
